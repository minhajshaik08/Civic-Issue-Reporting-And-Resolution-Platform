...
function OfficerSecuritySettingsPage() {
  ...
  const handleChangePassword = async (e) => {
    ...
    setLoading(true);
    try {
      // backend endpoint - table will be "officers" for officer users
      const res = await fetch(
        "http://localhost:5000/api/login/change-password",
        {
          ...
          body: JSON.stringify({
            ...
            table: "officers", // always "officers" for this page
            currentPassword,
            newPassword,
          }),
        }
...
export default OfficerSecuritySettingsPage;
